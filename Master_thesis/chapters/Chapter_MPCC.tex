...
\begin{figure}[!htb]
    ...
    \resizebox{\figurewidth}{\figureheight}{\input{figures/Chapter_MPCC/blue_test_boxplot}}
    % \input{figures/Chapter_MPCC/blue_test_boxplot}
