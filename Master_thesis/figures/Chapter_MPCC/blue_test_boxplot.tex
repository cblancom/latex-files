...
xmajorgrids,
tick label style={font=\scriptsize},   % etiquetas de los ticks
label style={font=\scriptsize},        % etiquetas de los ejes (xlabel, ylabel)
xmin=0.7, xmax=7.1,
...
ylabel=\textcolor{black}{Weymouth Error [MMSCFD]},
ymajorgrids,
...
\node[draw,fill=white,anchor=north east] at (axis description cs:0.975,0.3) {
    \scriptsize
    \begin{tabular}{@{}cl@{}}
        \tikz\draw[green,fill=green] (0,0) rectangle +(0.8cm,0.15cm); & Taylor \\
        \tikz\draw[blue,fill=blue] (0,0) rectangle +(0.8cm,0.15cm); & SOC \\
        \tikz\draw[red,fill=red] (0,0) rectangle +(0.8cm,0.15cm); & MPCC \\
    \end{tabular}
};
