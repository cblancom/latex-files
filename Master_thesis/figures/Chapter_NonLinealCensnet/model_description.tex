\begin{tikzpicture}[shorten >=1pt, ->, draw=black!50, node distance=1.5cm and 3.5cm, align=center]
    ...
    % Outputs
    \node[output] (node_output) [right of=post_dense, xshift=3cm, yshift=3cm] {Node Predictions};
    \node[output] (edge_output) [right of=post_dense, xshift=3cm, yshift=1cm] {Edge Predictions};
    \node[output] (balance_output) [right of=post_dense, xshift=3cm, yshift=-1cm] {Balance Layer};
    \node[output] (weymouth_output) [right of=post_dense, xshift=3cm, yshift=-3cm] {Weymouth Layer};
