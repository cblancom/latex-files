...
\node[
    ...
    \begin{tabular}{@{}cl}
        \begin{tikzpicture}[baseline]
            \path[draw=green, fill=green] (0,0) rectangle (0.4,0.2);
        \end{tikzpicture} & Taylor \\
        \begin{tikzpicture}[baseline]
            \path[draw=blue, fill=blue] (0,0) rectangle (0.4,0.2);
        \end{tikzpicture} & SOC \\
        \begin{tikzpicture}[baseline]
            \path[draw=red, fill=red] (0,0) rectangle (0.4,0.2);
        \end{tikzpicture} & MPCC \\
    \end{tabular}
};
