...
\setbeamertemplate{footline}
{
  ...
  \hbox{%
    ...
    \begin{beamercolorbox}[wd=0.33\paperwidth,ht=2.5ex,dp=1.125ex,right]{date in head/foot}%
      \tiny \insertshortdate{} \hspace{1em} \insertframenumber{} / \inserttotalframenumber \hspace{1em}
    \end{beamercolorbox}%
  }%
  \vskip0pt%
}
...
\justifying
\footnotesize % Aplícalo al texto general

\begin{itemize}
    \footnotesize % Asegura que se aplique dentro del itemize
    ...
    \begin{itemize}
        \footnotesize % También en el sub-itemize
...
\midrule
CensNet (N)     & 0.988 & -2.818 & 23.76 & $0.86 \pm 0.50$ \\
CensNet (N+E)   & 0.988 &  0.999 & 0.008 & $0.85 \pm 0.50$ \\
\midrule
\multicolumn{5}{c}{\textbf{63-node Network}} \\
\midrule
CensNet (N)     & 0.996 & -5.880 & 62.61 & $0.86 \pm 0.50$ \\
CensNet (N+E)   & 0.996 &  0.996 & 0.070 & $0.85 \pm 0.50$ \\
\bottomrule
\end{tabular}
\caption{Performance of CensNet (N) and CensNet (N+E) on synthetic (8-node) and real (63-node) networks.}
\end{table}
