...
% -----------------------------
% Slide 2: Edge layer propagation
% -----------------------------
...
%         \begin{itemize}
%             \footnotesize 
%             \item (N)   lower accuracy: $R^2$ = -2.818 (8-node) and -5.88 (63-node)
...
% \begin{tabular}{lcccc}
% \toprule
% \textbf{Model} & \textbf{Nodal $R^2$} & \textbf{Edge $R^2$} & \textbf{Balance Error} & \textbf{Time (s)} \\
% \midrule
% \multicolumn{5}{c}{\textbf{8-node Network}} \\
% \midrule
% CensNet (N)     & 0.988 & -2.818 & 5.71 \pm 16.86 & $0.650 \pm 0.442$ \\
% CensNet (N+E)   & 0.988 &  0.999 & 0.08 \pm 1.17 & $0.640 \pm 0.444$ \\
% \midrule
% \multicolumn{5}{c}{\textbf{63-node Network}} \\
% \midrule
% CensNet (N)     & 0.996 & -5.880 & 0.04 \pm 60.83 & $4.88 \pm 5.59$ \\
% CensNet (N+E)   & 0.996 &  0.996 & 0.01 \pm 23.4 & $4.87 \pm 5.59$ \\
% \bottomrule
% \end{tabular}
% \end{table}
%
...
% \begin{fleqn}[0pt] % left-justify just this block
%     \begin{subequations}
%     \begin{align}
...
%         % To assess the performance of Weymouth approximation approaches on the 8/9 system, 
...
%         \begin{figure}[H]
%             \centering
%             \setlength\figurewidth{1\linewidth}        
%             \setlength\figureheight{0.45\linewidth}
%             \includegraphics[width=\figurewidth, height=\figureheight]{figures/case1_cost.pdf} % Import PNG image here 
...
%             \setlength\figurewidth{1\linewidth}        
%             \setlength\figureheight{0.45\linewidth}
%             \includegraphics[width=\figurewidth, height=\figureheight]{figures/case1_error.pdf} % Import PNG image here 
...
% \scriptsize
% \begin{columns}[t,onlytextwidth]
%     % First Column: Text and Histogram Image
...
%     \end{column}
%     
%     % Second Column: Text and Error Plot Images
...
% \vspace{0.5em}
% \justifying
% % \textbf{Summary:} While all methods provide comparable costs, the MPCC approach offers a dramatic improvement in accuracy for the Weymouth equation approximation. 
% \end{frame}
...
% \scriptsize
% \begin{columns}[t,onlytextwidth]
%     % First Column: Text and Cost Image
%     \begin{column}{0.48\textwidth}
...
%     \end{column}
%     
%     % Second Column: Text and Error Plot Image
%     \begin{column}{0.48\textwidth}
...
%             \setlength\figurewidth{1\textwidth}        
%             \setlength\figureheight{0.45\textwidth}
%             \includegraphics[width=\figurewidth, height=\figureheight]{figures/case3_error.pdf} % Import PDF image here
...
%             % \subfloat[Pipeline flow ($f_m^t$)]{\label{fig:case3flow}\input{figures/red_test_scatter_flow}}
%         \end{figure}
%     \end{column}
% \end{columns}
%
...
\begin{itemize}
    ...
    \item Integrate with \textbf{hydrological series prediction tools} to anticipate gas consumption linked to hydro–thermal coordination.
\end{itemize}
\end{frame}
...
\begin{frame}{Acknowledgments}
    ...
    \begin{center}
        \includegraphics[height=1.5cm]{figures/logos/mie.jpg} \hspace{2cm}
